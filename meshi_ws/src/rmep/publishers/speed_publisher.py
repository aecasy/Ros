...
# Change this string according to plaintext protocol from RM SDK
# to retrieve different data from RM - for example - 'chassis speed ?;'
chassis_cmd = 'chassis status ?;'
